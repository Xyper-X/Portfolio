...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Top Navigation */}
      <nav className="bg-gray-900 border-b border-red-900 fixed w-full top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-6">
              {['about', 'skills', 'certificates', 'projects', 'blog', 'achievements'].map((item, index) => (
                <a 
                  key={item}
                  href={`#${item}`} 
                  className="py-2 px-4 text-gray-400 hover:text-red-500 transition-colors duration-300 relative group"
